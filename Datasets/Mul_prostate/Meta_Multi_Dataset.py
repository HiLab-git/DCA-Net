...
class Meta_Multi_Dataset(Dataset):
    def __init__(self, npz_dir='./data/npz_data', datalist_list=None, mode='train', transform=None):
        '''
        ...
        if self.mode == 'train':
            ...
            with open(self.datalist_list, 'r') as f:
                ...
                random.shuffle(self.image_list)
                self.image_list = [item.replace('\n', '') for item in self.image_list[:round(len(self.image_list)*0.3)]]
...
if __name__ == '__main__':
    ...
    dataset = Meta_Multi_Dataset(npz_dir='./data/npz_data', datalist_dir='./Datasets/Mul_s', mode='train')
